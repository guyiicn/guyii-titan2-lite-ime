...
import net.guyii.ime.databinding.ActivityLogBinding
import net.guyii.ime.ui.main.log.LogView
import net.guyii.ime.util.DeviceInfo
import net.guyii.ime.util.Logcat
import net.guyii.ime.util.iso8601UTCDateTime
