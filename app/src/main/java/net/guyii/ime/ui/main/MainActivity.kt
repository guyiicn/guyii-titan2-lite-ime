...
import net.guyii.ime.data.soundeffect.SoundEffectManager
import net.guyii.ime.databinding.ActivityMainBinding
import net.guyii.ime.ui.setup.SetupActivity
import net.guyii.ime.util.isStorageAvailable
import net.guyii.ime.util.item
import net.guyii.ime.util.parcelable
import net.guyii.ime.util.startActivity
import net.guyii.ime.worker.BackgroundSyncWork
