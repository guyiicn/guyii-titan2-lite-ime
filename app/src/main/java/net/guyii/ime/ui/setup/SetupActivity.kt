...
import net.guyii.ime.databinding.ActivitySetupBinding
import net.guyii.ime.ui.main.MainActivity
import net.guyii.ime.ui.setup.SetupPage.Companion.firstUndonePage
import net.guyii.ime.ui.setup.SetupPage.Companion.isLastPage
import net.guyii.ime.util.appContext
import net.guyii.ime.util.createNotificationChannel
