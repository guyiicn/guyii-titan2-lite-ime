...
import net.guyii.ime.core.Rime
import net.guyii.ime.core.RimeApi
import net.guyii.ime.core.RimeLifecycle
import net.guyii.ime.core.RimeMessage
import net.guyii.ime.core.lifecycleScope
import net.guyii.ime.core.whenReady
import net.guyii.ime.ui.main.LogActivity
import net.guyii.ime.util.DeployNotification
import net.guyii.ime.util.appContext
import net.guyii.ime.util.readText
import net.guyii.ime.util.subprocess
