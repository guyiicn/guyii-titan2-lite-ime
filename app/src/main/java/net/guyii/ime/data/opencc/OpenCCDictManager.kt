...
package net.guyii.ime.data.opencc

import net.guyii.ime.data.base.DataManager
import net.guyii.ime.data.opencc.dict.Dictionary
import net.guyii.ime.data.opencc.dict.OpenCCDictionary
import net.guyii.ime.data.opencc.dict.TextDictionary
