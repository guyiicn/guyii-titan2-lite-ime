...
import net.guyii.ime.util.yaml.enum
import net.guyii.ime.util.yaml.float
import net.guyii.ime.util.yaml.get
import net.guyii.ime.util.yaml.int
...
data class GeneralStyle(
    ...
    companion object {
         ...
         * [net.guyii.ime.data.theme.ThemeDiagnosticsTest] fails when this
