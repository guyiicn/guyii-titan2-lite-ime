...
Java_net_guyii_ime_core_Rime_getAvailableRimeSchemaList(JNIEnv* env,
                                                           jclass /* thiz */) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_net_guyii_ime_core_Rime_getSelectedRimeSchemaList(JNIEnv* env,
                                                          jclass /* thiz */) {
  SwitcherSettings switcher;
...
Java_net_guyii_ime_core_Rime_selectRimeSchemas(JNIEnv* env,
                                                  jclass /* thiz */,
                                                  jobjectArray array) {
  SwitcherSettings switcher;
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_net_guyii_ime_data_userdict_UserDictManager_getUserDictList(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_data_userdict_UserDictManager_backupUserDict(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_data_userdict_UserDictManager_restoreUserDict(
...
Java_net_guyii_ime_data_userdict_UserDictManager_exportUserDict(
...
extern "C" JNIEXPORT jint JNICALL
Java_net_guyii_ime_data_userdict_UserDictManager_importUserDict(
    JNIEnv* env, jclass clazz, jstring dict_name, jstring text_file) {
  SwitcherSettings switcher;
