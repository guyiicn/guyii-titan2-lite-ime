...
extern "C" JNIEXPORT void JNICALL Java_net_guyii_ime_core_Rime_startupRime(
...
Java_net_guyii_ime_core_Rime_exitRime(JNIEnv* env, jclass /* thiz */) {
  Rime::Instance().exit();
}

// deployment
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_deployRimeSchemaFile(JNIEnv* env,
                                                     jclass /* thiz */,
                                                     jstring schema_file) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_deployRimeConfigFile(JNIEnv* env,
                                                     jclass /* thiz */,
                                                     jstring file_name,
                                                     jstring version_key) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_syncRimeUserData(JNIEnv* env,
                                                 jclass /* thiz */) {
...
// input
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_processRimeKey(JNIEnv* env, jclass /* thiz */,
                                               jint keycode, jint mask) {
  return Rime::Instance().processKey(keycode, mask);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_commitRimeComposition(JNIEnv* env,
                                                      jclass /* thiz */) {
  return Rime::Instance().commitComposition();
}

extern "C" JNIEXPORT void JNICALL
Java_net_guyii_ime_core_Rime_clearRimeComposition(JNIEnv* env,
                                                     jclass /* thiz */) {
...
Java_net_guyii_ime_core_Rime_getRimeCommit(JNIEnv* env, jclass /* thiz */) {
  auto commit = Rime::Instance().commit();
  return rimeCommitToJObject(env, *commit);
}

extern "C" JNIEXPORT jobject JNICALL
Java_net_guyii_ime_core_Rime_getRimeContext(JNIEnv* env, jclass /* thiz */) {
  auto context = Rime::Instance().context();
  return rimeContextToJObject(env, *context);
}

extern "C" JNIEXPORT jobject JNICALL
Java_net_guyii_ime_core_Rime_getRimeStatus(JNIEnv* env, jclass /* thiz */) {
  auto status = Rime::Instance().status();
  return rimeStatusToJObject(env, *status);
}

// runtime options
extern "C" JNIEXPORT void JNICALL Java_net_guyii_ime_core_Rime_setRimeOption(
    JNIEnv* env, jclass /* thiz */, jstring option, jboolean value) {
  Rime::Instance().setOption(*CString(env, option), value);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_getRimeOption(JNIEnv* env, jclass /* thiz */,
                                              jstring option) {
  return Rime::Instance().getOption(*CString(env, option));
}

extern "C" JNIEXPORT jobjectArray JNICALL
Java_net_guyii_ime_core_Rime_getRimeSchemaList(JNIEnv* env,
                                                  jclass /* thiz */) {
  return rimeSchemaListToJObjectArray(env, Rime::Instance().schemaList());
}

extern "C" JNIEXPORT jstring JNICALL
Java_net_guyii_ime_core_Rime_getCurrentRimeSchema(JNIEnv* env,
                                                     jclass /* thiz */) {
  return env->NewStringUTF(Rime::Instance().currentSchemaId().c_str());
}

extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_selectRimeSchema(JNIEnv* env, jclass /* thiz */,
                                                 jstring schema_id) {
...
// testing
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_simulateRimeKeySequence(JNIEnv* env,
                                                        jclass /* thiz */,
...
extern "C" JNIEXPORT jstring JNICALL
Java_net_guyii_ime_core_Rime_getRimeRawInput(JNIEnv* env,
                                                jclass /* thiz */) {
  return env->NewStringUTF(Rime::Instance().rawInput().data());
}

extern "C" JNIEXPORT jint JNICALL
Java_net_guyii_ime_core_Rime_getRimeCaretPos(JNIEnv* env,
                                                jclass /* thiz */) {
  return static_cast<jint>(Rime::Instance().caretPosition());
}

extern "C" JNIEXPORT void JNICALL
Java_net_guyii_ime_core_Rime_setRimeCaretPos(JNIEnv* env, jclass /* thiz */,
                                                jint caret_pos) {
  Rime::Instance().setCaretPosition(caret_pos);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_selectRimeCandidate(JNIEnv* env,
                                                    jclass /* thiz */,
                                                    jint index,
                                                    jboolean global) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_deleteRimeCandidate(JNIEnv* env,
                                                    jclass /* thiz */,
                                                    jint index,
                                                    jboolean global) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_guyii_ime_core_Rime_changeRimeCandidatePage(JNIEnv* env,
                                                        jclass clazz,
                                                        jboolean backward) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_net_guyii_ime_core_Rime_getRimeCandidates(JNIEnv* env, jclass clazz,
                                                  jint start_index,
                                                  jint limit) {
...
extern "C" JNIEXPORT jobject JNICALL
Java_net_guyii_ime_core_Rime_getRimeResponse(JNIEnv* env, jclass clazz,
