...
Java_net_guyii_ime_core_RimeKeyEvent_parse(JNIEnv* env, jclass clazz,
                                              jstring repr) {
  rime::KeyEvent ke;
...
Java_net_guyii_ime_core_RimeKeyEvent_getModifierByName(JNIEnv* env,
                                                          jclass /* thiz */,
                                                          jstring name) {
...
extern "C" JNIEXPORT jint JNICALL
Java_net_guyii_ime_core_RimeKeyEvent_getKeycodeByName(JNIEnv* env,
                                                         jclass /* thiz */,
                                                         jstring name) {
